"""
Composite pattern is a structural pattern that allows you to
...
class Component(ABC):
    ...
    def parent(self) -> Component:
        """
        Accessor for the parent of the component
        """
        return self._parent
...
class Composite(Component):
    ...
    def is_composite(self) -> bool:
        """
        A composite gets the result of its children's operations
        """
        return True
